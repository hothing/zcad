...
ZP:=$(shell lazbuild --pcp=$(PCP) cad_source/zcad.lpi  --get-expand-text=$$\(ProjPath\)../cad/bin/$$\(TargetCPU\)-$$\(TargetOS\))
...
ifneq ($(OSDETECT),OSX)
	lazbuild --pcp=$(PCP) --add-package cad_source/other/agraphlaz/lazarus/ag_graph.lpk
	lazbuild --pcp=$(PCP) --add-package cad_source/other/agraphlaz/lazarus/ag_math.lpk
	lazbuild --pcp=$(PCP) --add-package cad_source/other/agraphlaz/lazarus/ag_vectors.lpk
endif
	lazbuild --pcp=$(PCP) --add-package cad_source/other/uniqueinstance/uniqueinstance_package.lpk
	lazbuild --pcp=$(PCP) --add-package cad_source/components/metadarkstyle/metadarkstyle.lpk
	lazbuild --pcp=$(PCP) --add-package cad_source/components/zcontainers/zcontainers.lpk
	lazbuild --pcp=$(PCP) --add-package cad_source/components/zbaseutils/zbaseutils.lpk
	lazbuild --pcp=$(PCP) --add-package cad_source/components/zbaseutilsgui/zbaseutilsgui.lpk
	lazbuild --pcp=$(PCP) --add-package cad_source/components/zebase/zebase.lpk
	lazbuild --pcp=$(PCP) --add-package cad_source/components/zcontrols/zcontrols.lpk
	lazbuild --pcp=$(PCP) --add-package cad_source/components/zmacros/zmacros.lpk
	lazbuild --pcp=$(PCP) --add-package cad_source/components/zmath/zmath.lpk
	lazbuild --pcp=$(PCP) --add-package cad_source/components/zobjectinspector/zobjectinspector.lpk
	lazbuild --pcp=$(PCP) --add-package cad_source/components/zscriptbase/zscriptbase.lpk
	lazbuild --pcp=$(PCP) --add-package cad_source/components/zscript/zscript.lpk
	lazbuild --pcp=$(PCP) --add-package cad_source/components/ztoolbars/ztoolbars.lpk
	lazbuild --pcp=$(PCP) --add-package cad_source/components/zundostack/zundostack.lpk
	lazbuild --pcp=$(PCP) --add-package cad_source/components/fpdwg/fpdwg.lpk
	lazbuild --pcp=$(PCP) --add-package cad_source/components/fpspreadsheet/laz_fpspreadsheet_visual_dsgn.lpk
	lazbuild --pcp=$(PCP) --add-package cad_source/components/lape/package/lape.lpk
	lazbuild --pcp=$(PCP) --add-package cad_source/components/zreaders/zreaders.lpk
	lazbuild --pcp=$(PCP) --add-package cad_source/components/fphunspell/fphunspell.lpk
